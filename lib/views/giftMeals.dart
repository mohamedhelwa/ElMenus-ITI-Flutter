        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              Image(image: AssetImage('assets/gifting.png')),
              SizedBox(
                height: 30,
              ),
              Column(
                children: [
                  ...
                  Image(image: AssetImage('assets/amount.png')),
                  SizedBox(
                    height: 5,
                  ),
                  Text(
                  ...
                  Image(image: AssetImage('assets/phones.png')),
                  SizedBox(
                    height: 5,
                  ),
                  Text(
                  ...
                  Image(image: AssetImage('assets/gifts.png')),
                  SizedBox(
                    height: 5,
                  ),
                  Text(
