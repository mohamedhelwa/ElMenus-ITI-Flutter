            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  new Text('$dishQuantity', style: new TextStyle(fontSize: 40.0)),
                  new FloatingActionButton(
                    onPressed: () {
                      setState(() {
                        dishQuantity++;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (){
                        Dish selectedDish = new Dish(
                          dishDescription: widget.dishData['dishDescription'].toString(),
                          dishImage: widget.dishData['dishImage'].toString(),
